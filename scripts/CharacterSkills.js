...
function SweepingStrike()
{
	...
	this.cooldown = 1;
	this.imageURL = "images/StillShapes/BSGStills/FRONT-Sweeping_Strike.jpg";
...
function DefensiveStance()
{
	...
	this.cooldown = 1;
	this.imageURL = "images/StillShapes/BSGStills/FRONT-Defensive_Stance.jpg";
...
function Focus()
{
	...
	this.cooldown = 1;
	this.imageURL = "images/StillShapes/BSGStills/FRONT-Focus.jpg";
	this.soundID = "focus";
}
